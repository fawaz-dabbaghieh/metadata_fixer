...
while True:
	old_file_path = raw_input("Please give the path to the old file or typ Q/q to exit :")
	if os.path.exists(old_file_path):
		break
	elif old_file_path == "Q" or old_file_path == "q":
		sys.exit()
	else:
		print("File does not exists, please give a correct path: \n")


while True:
	new_file_path = raw_input("please give the path to the new file :")
	if os.path.exists(new_file_path):
		break
	elif new_file_path == "Q" or new_file_path == "q":
		sys.exit()
	else:
		print("File does not exists, please give a correct path \n")
