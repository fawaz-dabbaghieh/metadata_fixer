...
#TODO
#   1- the dictionaries stuff   (done)
#   2- optional arguments for functions
#   3- Regular expressions for samples
#   3- make controlled vocabulary pipeline works for only experiments or only samples   (I think done, needs testing)
