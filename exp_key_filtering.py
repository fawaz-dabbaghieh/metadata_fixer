...
for f in all_files:
	...
	f_read_keys = codecs.open("../tmp_metadata/experiment/all_experiments/keys/"+f, encoding = "UTF-8-sig")
	...
	f_read_file = codecs.open(f,encoding = "UTF-8-sig")
	...
	f_write = open("filtered_exp/"+f, "w+") #opening writing
